    ...
    return (
        <>
            <section className="mt-40 container flex flex-col lg:flex-row gap-y-10 justify-between py-10">
                <div className="lg:w-[30%]">
                    ...
                    <p className="my-10 leading-loose text-lg">
                        ...
                        maximus volutpat. Cras et vestibulum lectus. Nulla turpis dui,
                        euismod rutrum tincidunt sit amet, pharetra id purus. Pellentesque
                        non interdum nisi. Aliquam vitae commodo ex.
                    </p>
            ...
            <div className="container py-5 text-sm">
                <p>© All rights reserved. Made by <span className='underline'> Code Studio</span></p>
            </div>
        </>
    );
};
